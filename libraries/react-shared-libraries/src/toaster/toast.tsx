...
export const Toast: FC<ToastProps> = ({
  ...
  const filterId = `toast-glow-${filterUid}`;

  return (
    <div
      className={clsx(
        'relative flex w-full min-h-[52px] items-center gap-3 overflow-hidden rounded-full bg-customColor8 px-5 py-3 text-white',
        isSuccess ? 'shadow-greenToast' : 'shadow-yellowToast',
        className
      )}
      role="status"
    >
      ...
      <div className="relative z-[1] min-w-0 flex-1 text-start text-sm font-medium leading-snug text-textColor">
        {message}
      </div>
      <svg
        xmlns="http://www.w3.org/2000/svg"
