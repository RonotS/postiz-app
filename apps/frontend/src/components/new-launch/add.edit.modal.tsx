    ...
    <>
      ...
      <style>
        ...
        {`@media (max-width: 1025px) {
          body:has(#add-edit-modal) .bg-popup {
            overflow: hidden !important;
          }
          body:has(#add-edit-modal) .copilotKitButton,
          body:has(#add-edit-modal) [class*="copilotKitButton"],
          body:has(#add-edit-modal) [class*="copilotKitPopup"] {
