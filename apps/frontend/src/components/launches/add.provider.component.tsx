...
export const AddProviderButton: FC<{
  ...
  return (
    <div className="flex group-[.sidebar]:block gap-[8px] mobile:gap-1.5">
      <button
        type="button"
        disabled={disabled}
        aria-disabled={disabled}
        className={clsx(
          'flex-1 group-[.sidebar]:w-[100%] group-[.sidebar]:flex-none text-btnText bg-btnSimple h-[44px] pt-[12px] pb-[14px] ps-[16px] pe-[20px] mobile:h-[34px] mobile:min-h-[34px] mobile:max-h-[34px] mobile:pt-0 mobile:pb-0 mobile:ps-[10px] mobile:pe-[12px] mobile:gap-1.5 mobile:rounded-[6px] justify-center items-center flex rounded-[8px] gap-[8px]',
      ...
      >
        <div>
          <svg
            ...
            viewBox="0 0 20 20"
            fill="none"
            className="mobile:w-4 mobile:h-4 shrink-0"
          >
            <path
        ...
        <div className="text-start text-[14px] mobile:text-[12px] group-[.sidebar]:hidden whitespace-nowrap">
      ...
      <button
        ...
        className={clsx(
          'group-[.sidebar]:hidden min-h-[44px] min-w-[44px] mobile:min-h-[34px] mobile:min-w-[34px] mobile:h-[34px] bg-btnSimple justify-center items-center flex rounded-[8px] mobile:rounded-[6px] cursor-pointer shrink-0',
          disabled && disabledClass
        )}
      >
        <svg
    ...
    <div className="flex flex-col gap-[16px] pt-[8px]">
      <p className="text-[14px] text-textColor/80">
        {t(
          ...
          'The TweetMax browser extension is not installed. You need to install it before connecting this channel.'
        )}
      </p>
  ...
  return (
    <div className="flex flex-col gap-[16px] pt-[8px]">
      ...
      <ul className="flex flex-col gap-[8px] list-disc ps-[20px] text-[14px] text-textColor/80">
        ...
        <li>
          TweetMax does not take responsibility for any issues arising or account
          ...
          try {
            ...
            toaster.show(
              t(
                ...
                'TweetMax browser extension is not installed or not reachable.'
              ),
              'warning'
            );
            return;
